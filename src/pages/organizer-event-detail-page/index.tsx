...
const EventDetails = () => {
    ...
    const [imagePath, setImagePath] = useState(data?.path || '/no-image.png');
    ...
    return (
        <div className="mt-16 flex flex-col mx-auto bg-white p-8 rounded-xl shadow-md text-sm">
            <div className='flex flex-row justify-between mb-16'>
                ...
                <h2 className="text-center text-2xl font-semibold mb-6">Event Details</h2>
            ...
            {isEditMode &&
                <div className='mt-16 border border-color-gray rounded-lg p-2 w-fit'>
                    <input
                        type="file"
                        accept="image/*"
